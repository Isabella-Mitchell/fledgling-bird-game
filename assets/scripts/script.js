...
const CONFIG = {
  blackbird: {
    ...
    funFact:
      "Did you know... Male blackbirds (such as this one) live up to their name but, confusingly, female blackbirds are brown with a yellow-brownish beak",
    quiz: [
      {
        ...
        options: [
          "Smaller than 20 cm",
          "Between 20cm and 30cm",
          "Between 30cm and 50cm",
          "Larger than 50cm",
        ],
  ...
  blueTit: {
    ...
    funFact:
      "Did you know... Blue tits are extremely social birds. They can be spotted in flocks of up to 20 strong and are happy to feed alongside other bird species.",
    quiz: [
      {
        question: "What size is the bird?",
        genre: "size",
      ...
      },
      {
        ...
        options: [
          "Moving through a dense bush",
          "Building a nest beside water",
          "Flying high above a field",
          "Perching on a feeder with a flock",
        ],
      ...
      },
      {
        ...
        options: [
          "A blue head with a black eye stripe",
          "Long red legs and a red beak",
          "A grey head and an orange breast",
          "A long hooked beak",
        ],
  ...
  cormorant: {
    ...
    funFact:
      "Fun fact... Cormorants dive underwater to catch food. That's why you'll often see them standing like this, to dry their wings out after diving.",
    quiz: [
      {
        question: "What size is the bird?",
        genre: "size",
      ...
      },
      {
        ...
        options: [
          "Blacky-Brown and White",
          "Yellow, Green and Grey",
          "Brown, White and Red",
          "Bluey-Yellow and White",
        ],
      ...
      },
      {
        ...
        options: [
          "Perching on a feeder",
          "Perching on a rooftop",
          "Perching beside water",
          "Perching in a tree",
        ],
  ...
  magpie: {
    ...
    funFact:
      "Fun fact... Magpies possess an extremely long tail. In fact, a magpie’s tail is often roughly the same length as its entire body.",
    quiz: [
      {
        question: "What size is the bird?",
        genre: "size",
      ...
      },
      {
        ...
        options: [
          "Long iridescent blue-green tail feathers",
          "A green head with a black eye stripe",
          "A black head and a red breast",
          "An orange-yellow beak",
        ],
  ...
  goldfinch: {
    ...
    funFact:
      "Did you know... The collective name for these highly colourful birds is a 'charm'. The term is derived from old English and refers to the goldfinches’ twittering song.",
    quiz: [
      {
        question: "What size is the bird?",
        genre: "size",
...
function setFinalResultsFeedback() {
  ...
  if (game.score >= 15) {
    finalResultsFeedback =
      "Congratulations, you can now identify these common British birds";
  } else if (game.score >= 10 && game.score <= 14) {
    finalResultsFeedback =
      "Well done, you have a good chance of being able to identify these common British birds";
  } else if (game.score <= 9) {
    finalResultsFeedback =
      "Commiserations. Why not have another go to improve your bird identifying skills?";
  }
...
function removeCompletedBird() {
  $(".highlight")
    .removeClass("bird-select")
    .removeClass("highlight")
    .attr("src", game.currentBird.finishedImageSrc);
}
...
function changeNavBarButtons() {
  ...
  $("#clock-nav-button").addClass("d-none");
}
